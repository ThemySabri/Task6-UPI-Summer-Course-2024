...
# Membuat dan menyimpan grafik jumlah total sampah tahunan di setiap provinsi untuk tahun 2023 dalam bentuk diagram batang
plt.figure(figsize=(10, 6))
total_sampah_2023 = total_sampah_tahunan[total_sampah_tahunan['Tahun'] == 2023]
plt.bar(total_sampah_2023['Provinsi'],
        total_sampah_2023['Timbulan Sampah Tahunan(ton)'], color='blue')
plt.xlabel('Provinsi')
plt.ylabel('Timbulan Sampah (ton)')
plt.title('Jumlah Total Sampah Tahunan di Setiap Provinsi (2023)')
plt.savefig('static/total_sampah_tahunan_2023.png')
plt.close()
